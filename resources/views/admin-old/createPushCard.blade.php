          ...
          <div class="profileinfo">
            <div class="row">
              ...
              <div class="col-lg-12 col-md-12">
                <form id="createcard" action="{{route('addPushCard')}}" method="POST" enctype="multipart/form-data">
                      @csrf
                <div class="row"> 
                ...
                <div class="form-group">
                    <label for="exampleFormControlFile1">Upload Phone size image
                        <input type="file" class="form-control-file" name="file" value=""  id="exampleFormControlFile1"
                 ...
                 <div class="col-lg-8 col-md-12">
                  ...
                  <div class="row mt-3">
                    <div class="col">
                      <textarea class="form-control" id="exampleFormControlTextarea1" name="description" value="{{old('description')}}" rows="6"
                  ...
                  <div class="pushcard-btn">
                    <input type="submit" value="Push Card" class="btn-custom btn-blue"></input>
                    </div>
                   </div>
                 </div>
                  </form>
