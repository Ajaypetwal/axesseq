              ...
              <div class="row">
                <div class="col-lg-4 col-md-4">
                  <div class="brooklynimg">
                    <img class="imageSize" src="{{asset('')}}{{$recruOrgData->image}}" alt="">
                  </div>
                </div>
                ...
                <div class="col-lg-5 col-md-6">
                  ...
                  <form action="{{route('approveReject')}}" method="POST"> 
                      @csrf
                        ...
                        @if(empty($recruOrgData->approval))
                      ...
                      @endif
                      @if(isset($recruOrgData->approval))
                      @if($recruOrgData->approval == 2)
                         <button type="submit" name="approve" value="1" class="btn-custom btn-green">Approve</button>
                      @endif
                      @if($recruOrgData->approval == 1 )   
                       <button type="submit" name="approve" value="2" class="btn-custom btn-red">Reject</button>
                      @endif
                     @endif
                    </form>
                    ...
                    <div class="row">
                      <div class="col-lg-4 col-md-6">
                        <div class="basicinfo-inner">
                          ...
                          <p><strong>@if(isset($recruOrgData->userinfo->company_name)){{$recruOrgData->userinfo->company_name}}@endif</strong></p>
                        </div>
                      </div>
                      <div class="col-lg-4 col-md-6">
                        <div class="basicinfo-inner">
                          <label class="basicinfo-p">Company Email:</label>
                          <p><strong>@if(isset($recruOrgData->userinfo->company_email)){{$recruOrgData->userinfo->company_email}}@endif</strong></p>
                        </div>
                      </div>
                      <div class="col-lg-4 col-md-6">
                        <div class="basicinfo-inner">
                          <label class="basicinfo-p">Company Phone:</label>
                          <p><strong>@if(isset($recruOrgData->userinfo->company_phone)){{$recruOrgData->userinfo->company_phone}}@endif @if(isset($recruOrgData->userinfo->business_number)){{$recruOrgData->userinfo->business_number}}@endif</strong></p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row">
                      <div class="col-lg-4 col-md-6">
                        <div class="basicinfo-inner">
                          ...
                          <p><strong>@if(isset($recruOrgData->userinfo->business_address)){{$recruOrgData->userinfo->business_address}}@endif</strong></p>
                        </div>
                      </div>
                      <div class="col-lg-4 col-md-6">
                        <div class="basicinfo-inner">
                          <label class="basicinfo-p">Website:</label>
                          <p><strong>@if(isset($recruOrgData->userinfo->website)){{$recruOrgData->userinfo->website}}@endif</strong></p>
                        </div>
                      </div>
                      <div class="col-lg-4 col-md-6">
                    ...
                    <div class="row">
                      <div class="col-lg-4 col-md-6">
                        <div class="basicinfo-inner">
                          ...
                          <p><strong>@if(isset($recruOrgData->companyinfo->industry)){{$recruOrgData->companyinfo->industry}}@endif</strong></p>
                        </div>
                      </div>
                      <div class="col-lg-4 col-md-6">
                        <div class="basicinfo-inner">
                          <label class="basicinfo-p">Size of Company:</label>
                          <p><strong>@if(isset($recruOrgData->companyinfo->size_of_company)){{$recruOrgData->companyinfo->size_of_company}}@endif</strong></p>
                        </div>
                      </div>
                      <div class="col-lg-4 col-md-6">
                        <div class="basicinfo-inner">
                          <label class="basicinfo-p">Headquarters:</label>
                          <p><strong>@if(isset($recruOrgData->companyinfo->headquarters)){{$recruOrgData->companyinfo->headquarters}}@endif</strong></p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row">
                      <div class="col-lg-4 col-md-6">
                        <div class="basicinfo-inner">
                          ...
                          <p><strong>@if(isset($recruOrgData->companyinfo->founded)){{$recruOrgData->companyinfo->founded}}@endif</strong></p>
                        </div>
                      </div>
                      <div class="col-lg-4 col-md-6">
