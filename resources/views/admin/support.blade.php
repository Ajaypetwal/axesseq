    ...
    <div id="back-panel">
        <div class="row marginZero">
            ...
            <main role="main" class="contentPart">
                <div class="">
                    <div class="backbtn">
                        <a href="#" id="sidebar-control" onClick="$('#sidebarMenu').toggle()"><img
                                src="{{ URL::asset('admin/images/leftarrow.svg') }}"></a>
                        <h1 class="h2"> Support</h1>

                    </div>
                    <div class="responsemsg"></div>
                    <div class="profileinfo" id="mainChatDiv">
                        ...
                        <div class="row">
                            ...
                            if(!empty($professionaldata)){
                              foreach ($professionaldata as $user) {
                                ...
                                //  print_r($user);
                              ?>
                                                <div class="active_msg mt-4 read-unread" data-user_id="{{ $user['user_id'] }}"
                                                    ...
                                                    <div class="supp_msg">
                                                        ...
                                                        <div class="supp_msg_content">
                                                            ...
                                                            <div class="text-right">
                                                               @if(!empty($user['countMessage_pro']))
                                                                 <span class="supp_msg_count">{{$user['countMessage_pro']}}</span>
                                                                @endif
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="active_msg mt-4 read-unread" data-user_id="{{ $user['user_id'] }}"
                                                    ...
                                                    <div class="supp_msg">
                                                        ...
                                                        <div class="supp_msg_content">
                                                            ...
                                                            <div class="text-right">
                                                            @if(!empty($user['countMessage_recru']))
                                                                 <span class="supp_msg_count">{{$user['countMessage_recru']}}</span>
                                                                @endif
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="active_msg mt-4 read-unread" data-user_id="{{ $user['user_id'] }}"
                                                    ...
                                                    <div class="supp_msg">
                                                        ...
                                                        <div class="supp_msg_content">
                                                            ...
                                                            <div class="text-right">
                                                            @if(!empty($user['countMessage_org']))
                                                                 <span class="supp_msg_count">{{$user['countMessage_org']}}</span>
                                                                @endif
                                                            </div>
                                                        </div>
                                                    </div>
                      ...
                      <img src="{{ URL::asset('admin/images/addchat.png') }}" alt="">
                            ...
                            <div class="col-lg-7 col-md-7 rightchat-wizard d-none">
                                <div class="supp_chat">
                                    ...
                                    <div class="chat_typing mt-4 align-items-center" id="formId">
                                ...
                                <div class="imageWarning text-danger">
                                </div>
                            </div>
                            <!-- Chat end here -->
                        </div>
    ...
    $(document).ready(function() {
        ...
        $(function() {
            ...
            $(document).on('change', '.gallery-photo-add',function() {
                      ...
                      var message = $('#exampleFormControlTextarea1').val();
                       ...
                       $.ajax({
                        ...
                        success: function(response) {
                            ...
                            count = 0;
                            // $('.gallery-photo-add').trigger("reset");
                            // $('#messageUserId').trigger("reset");
                            // $('#supportidMessage').trigger("reset");
                            // $('#exampleFormControlTextarea1').trigger("reset");
                            $('.imageWarning').addClass('d-none')
                            ...
                            if (response.success == true) {
                                ...
                                $('#formId').css('position','initial');
                                $('#formId').attr('style', 'bottom: 20px !important');
                ...
                $('.imageWarning').removeClass('d-none')
                count++;
                $('.imageWarning').html('image already selected')
            }
            });
