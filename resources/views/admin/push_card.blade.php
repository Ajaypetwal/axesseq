        ...
        <main role="main" class="contentPart">
            <div class="pushbtn">
              ...
              <div class="btn-right-blue">
                <a href="{{route('create-push-card')}}" class="btn-custom btn-blue">Create New Card</a>
              </div>
            </div>
           ...
           <!-- // Card start here -->
              @if(isset($data) && count($data)>0)
               ...
               <div class="card custom-card mb-3 mt-5 border-botm">
                <div class="row">
                <!-- .border-botm col-md-4 .col-sm-4 .card-logo-cls -->
                  <div class="col-md-4 col-sm-4">
                    <img src="images/{{$value->image}}" class="card-logo-cls" alt="badges">
                  </div>
                  ...
                  <div class="col-md-8 col-sm-8">
                    <div class="card-body cus-card-body">
                      ...
                      <p class="date">{{date('d. m. Y',strtotime($value->updated_at))}}</p>
