              ...
              <div class="col-md-12">
                <div class="tab-content">
                  <div id="forapproval" class="tab-pane active approval-div">
                    ...
                    <div class="card ad-custom-card mb-3 mt-4 pt-5 ads-border-botm ads-border-top">
                      <div class="row">
                          ...
                          <div class="card-body cus-card-body">
                            <div class="title-icon">
                              <div>
                                ...
                                <p class="ads-date">{{date('d. m. Y',strtotime($value->created_at))}}</p>
                              </div>
...
$(document).click(function(e) {
  $('.dropMenu').hide(); // gives the element's ID 
