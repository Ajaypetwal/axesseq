              ...
              <!-- <input type="hidden" name="_token" value="{{ csrf_token() }}" /> -->
                ...
                <div class="push-form">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-12 mt-2">
                        <input type="text" class="form-control" id="toall" name="" value="" placeholder="To: All" required readonly>
                        </div>
                        ...
                        <div class="pushform-area">
                            ...
                            <div class="row">
                                <div class="span6">
                                   <textarea id="emojionearea1" name="emoji"></textarea>
...
<script>
  ...
  $('.title_cls,#exampleFormControlTextarea1').keyup(function(){
    var descrip_val = $('#exampleFormControlTextarea1').val();
    var count = descrip_val.length; 
  console.log(descrip_val);
...
jQuery(document).ready(function() {
        jQuery("#exampleFormControlTextarea1").emojioneArea({
            pickerPosition: "left",
            tonesStyle: "bullet",
    ...
    jQuery("body").on('DOMSubtreeModified', ".emojionearea-editor", function() {
        var emojiText = jQuery('.emojionearea-editor').html();
        jQuery('.promodescription').html(emojiText);

        $('.emojionearea-editor').css("width", "10px"); 
    });
