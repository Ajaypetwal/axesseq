...
<script>
  ...
  $(document).on('click','.prof,.rec,.org',function(){
    $check =  $(this).is(":checked");
 //   console.log($check);
  //  $check =  console.log($(this).is(":checked"));
  if($check == true){
      $('.sendall').prop('disabled', true);
     }else {
      // console.log($(this).is(":checked"));
      console.log($(".prof").is(':checked'));
      $('.sendall').prop('disabled', false);
      //  $profChecked = $('.prof').prop('checked', false);
      //  $recChecked  = $('.rec').prop('checked', false);
      //  $orfChecked  = $('.org').prop('checked', false);

      //  if($profChecked.is(":checked") == 'false' && $recChecked.is(":checked") == 'false' && $orfChecked.is(":checked") == 'false'){
      //     $('.sendall').prop('disabled', false);
      //  }
    }
