                ...
                <div class="push-form">
                    ...
                    <div class="form-row">
                        ...
                        <div class="pushform-area">
                            ...
                            <div>
                                <textarea class="form-control descrip_clss" name="description" id="exampleFormControlTextarea1" cols="35"rows="1" placeholder="Write your message here" required></textarea>
                            </div>
...
//     console.log('dfdjfd');
//     var descrip_val = $('.emojionearea-editor').val();
//     var count = descrip_val.length;
//     $('.promodescription').html(descrip_val);
//     $('.wordcount').html(count);
