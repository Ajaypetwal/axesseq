              ...
              <!-- <input type="hidden" name="_token" value="{{ csrf_token() }}" /> -->
                ...
                <div class="push-form">
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-g19
PAGE EXPIREDroup col-md-4 col-sm-4 form-check">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-12 mt-2">
                        <input type="text"19
PAGE EXPIRED class="form-control" id="toall" name="toall[]" value="" placeholder="To: All" required readonly>
                        </div>
                        ...
                        <div class="pushform-area">
                            ...
                            <div>
                            push-noti<textarea class="form-control descrip_cls" name="description" id="exampleFormControlTextarea1" cols="35"rows="1" placeholder="Write your message here" required></textarea>
                            </div>
