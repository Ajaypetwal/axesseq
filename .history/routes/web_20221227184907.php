...
// Route::post('support-chat-media', [AdminController::class, 'createAdminMessage']);
// ---Admin dashboard--- //
Route::get('listing', [AdminController::class, 'indexList'])->name('indexList');
...
Route::get('professional-profile/{id}', [AdminController::class, 'showPro'])->name('showPro');
Route::post('approve-reject', [AdminController::class, 'approveReject'])->name('approveReject');

Route::get('profile/{id}', [AdminController::class, 'showRecruOrg'])->name('showRecruOrg');
...
Route::get('push-card', [AdminController::class, 'pushCardDash'])->name('pushCardDash');
Route::get('create-push-card', [AdminController::class, 'pushCard'])->name('create-push-card');
...
Route::get('guidelines', [AdminController::class, 'guideLineTerm'])->name('guideLineTerm');
Route::get('guide-line', [AdminController::class, 'guidLine'])->name('guidLine');
Route::get('edit-termCondition', [AdminController::class, 'editTermCon'])->name('editTermCon');
...
Route::get('push-notification', [AdminController::class, 'adminPushNotification'])->name('adminPushNotification');
Route::post('push-noti', [AdminController::class, 'adminPushNoti'])->name('adminPushNoti');
...
Route::get('read-unread', [AdminController::class, 'readUnread'])->name('readUnread');
