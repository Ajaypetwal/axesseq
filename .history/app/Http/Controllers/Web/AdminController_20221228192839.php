    ...
    public function pushNotificationGroup(){
     ...
     foreach($old_data as $value){
        ...
        if($value->date == $date){
            ...
            $serverKey = 'AAAAsfWDpA4:APA91bGBldnQHWPfMU2x6bsKunMHBhDhD8Vl7f9zGrhDmsLpaQ3MwCLArLY838KTVRfYZm907s9m0LCYczkq1Fwbg8JAWeJqZ0htZjWdMvPm_Nu5kYlJx2UVg8t5e4aS0P9MqR-J7x1c';
