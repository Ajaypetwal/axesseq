...
class Kernel extends ConsoleKernel
{
    ...
    {   
        // $schedule->call('App\Http\Controllers\Web\AdminController@pushNotificationGroup')->everyMinute();
       $schedule->call('App\Http\Controllers\Web\AdminController@pushNotificationGroup')->daily(); 
